...
function getContentTab(url,selector){
	...
	var loadding = '<div class="a-center a-center-loading"><img src="//bizweb.dktcdn.net/100/361/762/themes/799709/assets/rolling.svg?1706032052929"</div>'
	$.ajax({
		type: 'GET',
		url: url,
		beforeSend: function() {
...
$(document).ready(function(){
	...
	if (img_array.length == 1) {
		...
		$('.img_bg_product .bg1').attr("style" , "background-image:url(//bizweb.dktcdn.net/100/361/762/themes/799709/assets/bg_default_pro_1.jpg?1706032052929)");
		$('.img_bg_product .bg2').attr("style" , "background-image:url(//bizweb.dktcdn.net/100/361/762/themes/799709/assets/bg_default_pro_2.jpg?1706032052929)");
	}
...
$(document).on('click', function(event) {
	if (!$(event.target).closest('.float-vertical .float-vertical-button').length) {
		$('.float-vertical .block_content').addClass('hidden');
	} else {
		$('.float-vertical .block_content').removeClass('hidden');
	}
